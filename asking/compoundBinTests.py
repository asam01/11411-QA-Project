import unittest
from compoundBinary import ask_q as bin_q
...
class TestThirdPersonSingular (unittest.TestCase):
    ...
    def testSimpleCases(self):
        ...
        s4 = 'Johnny does not like shopping.'
        q4 = ['Does Johnny not like shopping?']
    ...
    def testComplexCases(self):
        ...
        s3 = 'Alice runs and Bob walks at the park.'
        q3 = ['Does Alice run?', 'Does Bob walk at the park?']
